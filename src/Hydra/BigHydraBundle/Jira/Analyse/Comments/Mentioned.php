...
class Mentioned
{
     ...
     */
    public function setMentionedFilter($mentionedFilter)
    {
        $this->mentionedFilter = $mentionedFilter;
    }

    /**
     * @return \string[]
     */
    public function getMentionedFilter()
    {
        return $this->mentionedFilter;
    }
    ...
    public function runReport()
    {
        ...
        $pipeline = $this->applyFilterForMentioned($pipeline, $this->mentionedFilter);
     ...
     * @return array
     */
    protected function applyFilterForMentioned(array $pipeline, array $authors)
    {
        if (0 < count($authors)) {
            $sections = [
                static::KEY_PRE_FILTER,
            ...
            foreach ($sections as $section) {
                $pipeline = $this->applySectionFilterForMentioned($pipeline, $section, $authors);
            }
        }
     ...
     * @return array
     */
    protected function applySectionFilterForMentioned(array $pipeline, $section, array $authors)
    {
        $collection = [];
